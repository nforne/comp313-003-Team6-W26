  ...
  try {
    ...
    const rawServices = [
      
      {
        ...
        description:
          'Need a professional haircut and styling for my wedding next month. Looking for someone experienced with formal hairstyles.',
        serviceType: 'haircut',
        location: 'Toronto, ON',
        ...
        bids: [
          {
            ...
            price: 85,
            message:
              'I specialize in wedding hairstyles. I can create a beautiful look for your special day!',
      ...
      },
      {
        ...
        description:
          'Suffering from chronic back pain. Need a professional deep tissue massage session.',
        serviceType: 'massage',
        location: 'Scarborough, ON',
        ...
        bids: [
          {
            ...
            price: 95,
            message:
              'I have extensive experience with deep tissue massage for pain relief. Let me help you feel better!',
      ...
      },
      {
        ...
        description:
          'Need a thorough deep cleaning of my 3-bedroom house. Including kitchen, bathrooms, and all living areas.',
        ...
        bids: [
          {
            ...
            price: 200,
            message:
              'I use eco-friendly products and provide a thorough deep clean. Your home will sparkle!',
      ...
      },
      {
        ...
        description:
          'My son needs help with Grade 11 math. Looking for a patient and experienced tutor.',
        ...
        bids: [
          {
            ...
            price: 45,
            message:
              'I have helped many students improve their math grades. I can definitely help your son!',
            estimatedDuration: 60,
          },
        ],
      },
