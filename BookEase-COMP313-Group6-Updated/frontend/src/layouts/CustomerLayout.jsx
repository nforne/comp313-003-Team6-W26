/**
 * @module layouts/CustomerLayout
 * @description Customer dashboard layout with sidebar navigation.
 */

import { Outlet, NavLink, useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { LayoutDashboard, Calendar, PlusCircle, Heart, LogOut, ArrowLeft, ClipboardList } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f5f5f7] flex">
        ...
        <div className="p-4 border-b border-apple-gray-200/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-apple-gray-500">Customer</p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 lg:ml-[260px] min-h-screen">
        ...
        <div className="lg:hidden glass-nav sticky top-0 z-30 px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-[15px] font-semibold">Customer Dashboard</span>
