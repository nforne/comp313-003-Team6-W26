...
const Dashboard = () => {
  ...
  const stats = [
    { label: 'Open Requests', value: openRequests.length, icon: Briefcase, color: 'text-apple-blue', bg: 'bg-blue-50' },
    { label: 'Active Bookings', value: bookings.filter((b) => ['confirmed', 'in_progress'].includes(b.status)).length, icon: Calendar, color: 'text-apple-orange', bg: 'bg-orange-50' },
